...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/GooglePlacesSearchController/Pod/Assets/powered-by-google-on-white.png"
  install_resource "${PODS_ROOT}/GooglePlacesSearchController/Pod/Assets/powered-by-google-on-white@2x.png"
fi
